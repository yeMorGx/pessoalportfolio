        ...
        <section className="mt-8 grid gap-6 lg:grid-cols-[1fr_26rem]">
                ...
                <div className="flex min-w-0 items-center gap-4">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="truncate text-sm text-slate-400">
                      {project.cover_display === "fullscreen" ? "Fullscreen" : "Miniatura"} - {Array.isArray(project.tech_stack) ? project.tech_stack.join(", ") : ""}
                    </p>
                  </div>
                </div>
          ...
          <aside className="border border-white/10 bg-white/[0.04] p-5">
            ...
            <form action={saveProjectAction} className="mt-6 space-y-4">
              ...
              <input name="video_url" className="w-full border border-white/12 bg-ink px-3 py-3 text-sm text-white outline-none focus:border-mint" placeholder="URL de vídeo/demo" defaultValue={selectedProject?.video_url ?? ""} />
