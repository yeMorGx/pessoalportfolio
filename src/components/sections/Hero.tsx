...
export function Hero() {
  ...
  return (
    <section ref={heroRef} className="relative min-h-[94svh] overflow-hidden border-b border-white/10 bg-ink px-5 pb-10 pt-24 sm:pb-12 sm:pt-28">
      ...
      <div className="relative mx-auto flex min-h-[calc(94svh-8.5rem)] max-w-7xl flex-col justify-end">
        ...
        <div data-hero-copy className="relative z-10 max-w-[50rem] pb-4 sm:pb-8">
          ...
          <div data-hero-meta className="mt-7 flex flex-wrap items-center gap-3">
            <a href="#projetos" className="group inline-flex h-12 items-center gap-2 rounded-sm bg-ceramic px-5 text-sm font-semibold text-ink transition-colors hover:bg-mint focus:outline-none focus-visible:ring-2 focus-visible:ring-mint focus-visible:ring-offset-2 focus-visible:ring-offset-ink">
              Ver projetos
              <PortfolioIcon name="down" className="h-3.5 w-3.5 transition-transform group-hover:translate-y-0.5" />
            </a>
            <a href="mailto:gabrielmcgoes@gmail.com" className="inline-flex h-12 items-center gap-2 rounded-sm border border-white/18 bg-ink/35 px-5 text-sm text-white backdrop-blur-sm transition-colors hover:border-coral/70 focus:outline-none focus-visible:ring-2 focus-visible:ring-coral">
              <Mail size={16} />
              Entrar em contato
            </a>
          </div>
