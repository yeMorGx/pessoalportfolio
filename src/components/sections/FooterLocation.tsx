...
export function FooterLocation() {
  ...
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      aria-label="Abrir Baixada Santista no Google Maps"
    ...
    >
      <div className="relative z-10 flex flex-col justify-between py-6 lg:py-8">
        ...
        <div className="mt-10 max-w-md lg:mt-0">
          ...
          <p className="mt-3 text-sm leading-6 text-ink/60">Baixada Santista, Brasil. Disponível para trabalho remoto e conexões além do litoral.</p>
        </div>
