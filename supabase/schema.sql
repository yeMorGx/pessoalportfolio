...
drop policy if exists "Portfolio admin can read contact messages" on public.contact_messages;
create policy "Portfolio admin can read contact messages" on public.contact_messages for select to authenticated using (public.is_portfolio_admin());
drop policy if exists "Portfolio admin can update contact messages" on public.contact_messages;
create policy "Portfolio admin can update contact messages" on public.contact_messages for update to authenticated using (public.is_portfolio_admin()) with check (public.is_portfolio_admin());
drop policy if exists "Portfolio admin can delete contact messages" on public.contact_messages;
create policy "Portfolio admin can delete contact messages" on public.contact_messages for delete to authenticated using (public.is_portfolio_admin());

drop policy if exists "Portfolio admin can read resume requests" on public.resume_requests;
create policy "Portfolio admin can read resume requests" on public.resume_requests for select to authenticated using (public.is_portfolio_admin());
drop policy if exists "Portfolio admin can update resume requests" on public.resume_requests;
create policy "Portfolio admin can update resume requests" on public.resume_requests for update to authenticated using (public.is_portfolio_admin()) with check (public.is_portfolio_admin());
drop policy if exists "Portfolio admin can delete resume requests" on public.resume_requests;
create policy "Portfolio admin can delete resume requests" on public.resume_requests for delete to authenticated using (public.is_portfolio_admin());

drop policy if exists "Portfolio admin can read private resume" on storage.objects;
create policy "Portfolio admin can read private resume" on storage.objects for select to authenticated using (bucket_id = 'private-resume' and public.is_portfolio_admin());
drop policy if exists "Portfolio admin can upload private resume" on storage.objects;
create policy "Portfolio admin can upload private resume" on storage.objects for insert to authenticated with check (bucket_id = 'private-resume' and public.is_portfolio_admin());
drop policy if exists "Portfolio admin can update private resume" on storage.objects;
create policy "Portfolio admin can update private resume" on storage.objects for update to authenticated using (bucket_id = 'private-resume' and public.is_portfolio_admin()) with check (bucket_id = 'private-resume' and public.is_portfolio_admin());
drop policy if exists "Portfolio admin can delete private resume" on storage.objects;
create policy "Portfolio admin can delete private resume" on storage.objects for delete to authenticated using (bucket_id = 'private-resume' and public.is_portfolio_admin());
